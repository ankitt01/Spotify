...
function Sidebar() {
    ...
    return (
        <div className="text-gray-400 p-5 text-xs lg:text-sm overflow-y-scroll scrollbar-hide h-screen border-r border-gray-900 sm:max-w-[12rem] lg:max-w-[15rem] hidden md:inline-flex">
